...
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (1, 'Pasta Carbonara', 'Kremasta italijanska pasta sa slaninom', 'PASTA', '/uploads/carbonara.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (2, 'Pizza Capricciosa', 'Pizza sa šunkom, pečurkama i sirom', 'PIZZA', '/uploads/capricciosa.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (3, 'Cezar salata', 'Salata sa piletinom, parmezanom i dresingom', 'SALAD', '/uploads/cezar.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (4, 'Coca cola', 'Osvežavajuće bezalkoholno piće, 330ml', 'DRINK', '/uploads/cola.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (5, 'Tiramisu', 'Kremasti italijanski desert sa kafom i maskarponeom', 'DESSERT', '/uploads/tiramisu.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (6, 'Pizza Margherita', 'Pizza sa paradajz pelatom i sirom', 'PIZZA', '/uploads/margherita.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (7, 'Rosa voda', 'Negazirana voda, 500ml', 'DRINK', '/uploads/rosa.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (8, 'Spaghetti Bolognese', 'Špagete u sosu od paradajza i mlevenog mesa', 'PASTA', '/uploads/bolognese.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (9, 'Čokoladni sufle', 'Topli kolač od čokolade sa kuglom sladoleda', 'DESSERT', '/uploads/sufle.jpg', true);
INSERT INTO menu_items (id, name, description, item_category, image_url, active) VALUES (10, 'Lasagna Bolognese', 'Zapečene lazanje sa mlevenim mesom i sirom', 'PASTA', '/uploads/lazagna.jpg', true);
